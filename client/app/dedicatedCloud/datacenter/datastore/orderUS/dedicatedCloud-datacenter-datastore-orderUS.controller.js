angular.module("App").controller("DedicatedCloudDatacentersDatastoreOrderUSCtrl", function ($state, $q, OvhHttp, User, serviceName, datacenterId) {
    "use strict";
    ...
    }).then((offers) => _.filter(offers, { family: "datastore" }))
        .then((offers) => {
